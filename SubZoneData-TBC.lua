...
function RepByZone:SubZonesAndFactionsList()
	...
	subZonesAndFactions = {
		...
		[GetAreaInfo(314)]		= GetFactionID(72, 68),		-- Go'Shek Farm/Stormwind or Undercity
		...
		[GetAreaInfo(439)]		= GetFactionID(54, 76),		-- The Shimmering Flats/Gnomeregan Exiles or Orgrimmar
		...
		[GetAreaInfo(1858)]		= GetFactionID(471, 530),	-- Boulder'gor/Wildhammer Clan or Darkspear Trolls
